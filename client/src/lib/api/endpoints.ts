...
export const PROFILE = {
    ...
    UPDATE_AVATAR: `${env.REACT_APP_API_URL}${API_ROUTES.PROFILE_UPDATE_AVATAR}`, 
    UPDATE_RESUME: `${env.REACT_APP_API_URL}${API_ROUTES.PROFILE_UPDATE_RESUME}`, 
} as const;
...
export const ANALYTICS = {
    ...
    CREATE: `${env.REACT_APP_API_URL}${API_ROUTES.ANALYTICS_CREATE}`,  // Added
    UPDATE: (id: string) => `${env.REACT_APP_API_URL}${API_ROUTES.ANALYTICS_UPDATE(id)}`,  // Added
    DELETE: (id: string) => `${env.REACT_APP_API_URL}${API_ROUTES.ANALYTICS_DELETE(id)}`,  // Added
